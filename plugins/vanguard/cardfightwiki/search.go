...
func init() {
	...
	shieldXPath = xpath.MustCompile(`//td[normalize-space(text())='Shield']/following-sibling::node()`)
	nationXPath = xpath.MustCompile(`//td[normalize-space(text())='Nation']/following-sibling::node()`)
	clanXPath = xpath.MustCompile(`//td[normalize-space(text())='Clan']/following-sibling::node()`)
	raceXPath = xpath.MustCompile(`//td[normalize-space(text())='Race']/following-sibling::node()`)
	triggerEffectXPath = xpath.MustCompile(`//td[normalize-space(text())='Trigger Effect']/following-sibling::node()`)
	formatsXPath = xpath.MustCompile(`//td[normalize-space(text())='Format']/following-sibling::node()`)
